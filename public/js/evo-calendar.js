...
(function(factory) {
  ...
  EvoCalendar.prototype.selectEvent = function(event) {
    ...
    var index = _.options.calendarEvents.map((event) => { return event.id }).indexOf(id);
  ...
  EvoCalendar.prototype.selectDate = function(event) {
    ...
    let date, year, month, activeDayEl, isSameDate;
  ...
  EvoCalendar.prototype.removeCalendarEvent = function(arr) {
    ...
    function deleteEvent(data) {
      // Array index
      var index = _.options.calendarEvents.map((event) => { return event.id }).indexOf(data);
